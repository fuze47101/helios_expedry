...
from components import SaveDialog, WarningDialog, WeighDialog
...
class FeatherInterface(FloatLayout):
    ...
    def start_test(self, *args):
        ...
        if self.running:
            ...
            self.ids.graph_test.remove_plot(self.weight_plot)
            self.can_save = False
            self.test_phase = 'WET'
            self.handle_outputs()
    ...
    def plot_data(self, *args):
        try:
            if self.test_mode == self.test_types[0] or self.test_mode == self.test_types[1]:
                ...
                # Enhanced CSV: time, humidity, temp, weight, delta, phase
            ...
            if self.drying and self.test_phase == 'DRY BACK':
                ...
                # Check if weight returned to within 0.05g of start
